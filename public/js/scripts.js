...
jQuery(document).ready(function ($) {
	// fhs page table dropdown open on dbclick
	//.x-grid3-cell-last
	//var dropParent = $('.x-grid3-cell-last select').parent()
	var dropDown = $(".x-grid3-cell-last select");
	var elm = $(".x-grid3-cell-last");
	//var elm = $(".table-responsive");
	dropDown.hide();

	for (var i = 0; i < elm.length; i++) {
		$(elm[i]).on("dblclick", function (e) {
			//Code here
